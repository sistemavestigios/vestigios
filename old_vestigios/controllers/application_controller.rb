class ApplicationController < ActionController::Base
  ...
  include Pundit
  include ActionView::Helpers::TextHelper # to use pluralize
  ...
  @@stop_words = ['de', 'a', 'o', 'que', 'e', 'do', 'da', 'em', 'um', 'para', 'é', 'com', 'não',
  ...
  def user_not_authorized
    action = { 'new' => 'criar',
               ...
               'destroy' => 'deletar',
               'edit' => 'editar' }
    controller = { 'texts' => 'esse texto',
                   'colors' => 'essa cor',
                   'definitions' => 'essa definição',
                   'errortogs' => 'esse erro',
                   'blocs' => 'esse bloco',
                   'users' => 'essa página' }
    flash[:notice] = "Você não está autorizado a #{action[action_name]} #{controller[controller_name]}"
